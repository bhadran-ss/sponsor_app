...
export default function ReceivedDeals() {
      ...
      <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_10px_40px_-24px_rgba(15,23,42,0.35)]">
        <div className="bg-slate-900 px-5 py-6 text-slate-50 sm:px-8">
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-300">
            Review incoming opportunities and respond to sponsors from one
            place.
          </p>
        </div>
          ...
          {deals.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-5 py-8 text-center">
              <p className="text-lg font-semibold text-slate-800">
                No sponsor interest yet.
              </p>
              <p className="mt-2 text-sm text-slate-500">
                New opportunities from sponsors will appear here.
              </p>
            </div>
          ) : (
